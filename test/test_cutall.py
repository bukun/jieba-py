...
if __name__ == '__main__':
    ...
    assert cuttest('C++和c#是什么关系？11+122=133，是吗？PI=3.14159')
    assert cuttest('你认识那个和主席握手的的哥吗？他开一辆黑色的士。') == [
        '你',
        '认识',
        '那个',
        '和',
    ...
    assert cuttest('超敏C反应蛋白是什么, java好学吗?,小潘老板都学Python') == [
        '超敏',
        '超敏C反应蛋白',
        '反应',
        '蛋白',
    ...
    assert cuttest('steel健身爆发力运动兴奋补充剂') == [
        'steel',
        '健身',
        '爆发',
        '爆发力',

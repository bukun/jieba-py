...
writer.add_document(
    title='document2', path='/b', content='The second one 你 中文测试中文 is even more interesting! 吃水果'
)

writer.add_document(title='document3', path='/c', content='买水果然后来世博园。')

writer.add_document(
    title='document4', path='/c', content='工信处女干事每月经过下属科室都要亲口交代24口交换机等技术性器件的安装工作'
)

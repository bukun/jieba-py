...
class JiebaTestCase(unittest.TestCase):
    ...
    def testDefaultCut(self):
        for content in test_contents:
            ...
            result = list(result)
            assert isinstance(result, list), f'Test DefaultCut error on content: {content}'
    ...
    def testCutAll(self):
        for content in test_contents:
            ...
            result = list(result)
            assert isinstance(result, list), f'Test CutAll error on content: {content}'
            print(' , '.join(result), file=sys.stderr)
    ...
    def testSetDictionary(self):
        ...
        for content in test_contents:
            ...
            result = list(result)
            assert isinstance(result, list), f'Test SetDictionary error on content: {content}'
            print(' , '.join(result), file=sys.stderr)
    ...
    def testCutForSearch(self):
        for content in test_contents:
            ...
            result = list(result)
            assert isinstance(result, list), f'Test CutForSearch error on content: {content}'
            print(' , '.join(result), file=sys.stderr)
    ...
    def testPosseg(self):
        ...
        for content in test_contents:
            ...
            result = list(result)
            assert isinstance(result, list), f'Test Posseg error on content: {content}'
